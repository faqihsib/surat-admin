<nav class="navbar navbar-header navbar-expand navbar-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav d-flex align-items-center navbar-light ml-auto">
            ...
            {{-- Menu Notifikasi (Dummy Tampilan) --}}
            ...
            <li class="dropdown">
                <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                    <div class="avatar mr-1">
                         {{-- Logika Foto Profil: Jika ada foto di DB pakai itu, jika tidak pakai Avatar default template --}}
                         @if(Auth::user()->foto_profil)
                            <img src="{{ asset('uploads/profile/' . Auth::user()->foto_profil) }}" alt="Avatar">
                        @else
                            <img src="{{ asset('assets/images/avatar/avatar-s-1.png') }}" alt="Avatar">
                        @endif
                    </div>
