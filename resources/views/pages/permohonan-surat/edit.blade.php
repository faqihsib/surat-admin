        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Form edit permohonan surat</p>
                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nomor_permohonan" name="nomor_permohonan"
                                        value="{{ old('nomor_permohonan', $permohonan->nomor_permohonan) }}" required
                                    ...
                                    <select class="form-control" id="pemohon_warga_id" name="pemohon_warga_id" required>
                                        ...
                                        @foreach ($dataWarga as $warga)
                                            <option value="{{ $warga->warga_id }}"
                                                {{ old('pemohon_warga_id', $permohonan->pemohon_warga_id) == $warga->warga_id ? 'selected' : '' }}>
                                    ...
                                    <select class="form-control" id="jenis_id" name="jenis_id" required>
                                        ...
                                        @foreach ($dataJenisSurat as $jenis)
                                            <option value="{{ $jenis->jenis_id }}"
                                                {{ old('jenis_id', $permohonan->jenis_id) == $jenis->jenis_id ? 'selected' : '' }}>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="status" name="status" required>
                                        <option value="Diajukan"
                                            {{ old('status', $permohonan->status) == 'Diajukan' ? 'selected' : '' }}>
                                            Diajukan</option>
                                        <option value="Diproses"
                                            {{ old('status', $permohonan->status) == 'Diproses' ? 'selected' : '' }}>
                                            Diproses</option>
                                        <option value="Selesai"
                                            {{ old('status', $permohonan->status) == 'Selesai' ? 'selected' : '' }}>Selesai
                                        </option>
                                        <option value="Ditolak"
                                            {{ old('status', $permohonan->status) == 'Ditolak' ? 'selected' : '' }}>Ditolak
                                        </option>
                                    </select>
                                    @error('status')
                                        <div class="text-danger small">{{ $message }}</div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="catatan" name="catatan" rows="3" placeholder="Masukkan catatan jika ada">{{ old('catatan', $permohonan->catatan) }}</textarea>
                                </div>
                            </div>
                        </div>
